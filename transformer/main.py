...
if __name__ == "__main__":
    transform_data("../datalake/bronze/diesel_uf_type.parquet", "../datalake/silver/diesel_uf_type")
    transform_data("../datalake/bronze/oil_uf_product.parquet", "../datalake/silver/oil_uf_product")